export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-cover bg-no-repeat" style={{ backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url('https://cdn.resonance.rest/bg.png')" }}>
      <img src="https://cdn.resonance.rest/logo.png" width="200" height="200" alt="Logo" />
      <h1 className="mt-4 text-zinc-50 text-2xl">resonance.rest</h1>
